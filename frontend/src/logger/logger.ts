...
class Logger {
  ...
  constructor(module: string) {
    const apiKey = process.env.NEXT_PUBLIC_LOGFLARE_API_TOKEN ?? "76ba79dd-d85a-42cc-854f-8eaadbe1e095";
    const sourceToken = process.env.NEXT_PUBLIC_LOGFLARE_CLIENT_TOKEN ?? "woM7iW_BIlR3";
